...
var addProducts = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orderId, quantity, productId, addNewProduct, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.addProducts(quantity, orderId, productId)];
            case 2:
                addNewProduct = _a.sent();
...
var order_routes = function (app) {
    ...
    app.post("/orders/:orderId/products", user_1.verifyAuthToken, addProducts);
};
