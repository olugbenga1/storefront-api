...
var OrderStore = /** @class */ (function () {
    ...
    OrderStore.prototype.create = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, checkUser, checkedUser, values, sql, res, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(checkUser, [order.userId])];
                    case 2:
                        checkedUser = _a.sent();
                        if (checkedUser.rows.length < 1)
                            "This user does not exist";
                        values = [order.status, order.userId];
                        sql = "INSERT INTO orders (order_status, userid) VALUES ($1, $2) RETURNING *";
