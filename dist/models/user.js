...
var UserStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Cannot return users ".concat(error_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, bcrypt_1["default"].hash(user.password + pepper, parseInt(saltrounds))];
                    case 2:
                        hash = _a.sent();
                    ...
                    case 4:
                        error_2 = _a.sent();
                        throw new Error("Cannot create new user ".concat(user.firstname, ", ").concat(user.lastname, " >> ").concat(error_2));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Cannot show user ".concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        throw new Error("Cannot delete user. ".concat(error_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    UserStore.prototype.updatePassword = function (id, user) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, hash, values, conn, res, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        sql = "UPDATE users SET password_digest = ($1) WHERE id = ($2) RETURNING *";
                        return [4 /*yield*/, bcrypt_1["default"].hash(user.password + pepper, parseInt(saltrounds))];
                    case 1:
                        hash = _a.sent();
                        values = [hash, id];
                    ...
                    case 4:
                        error_5 = _a.sent();
                        throw Error("Cannot update password. ".concat(error_5));
                    case 5: return [2 /*return*/];
                }
            });
        });
    ...
    UserStore.prototype.authenticate = function (firstname, lastname, password) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, res, user, correctPassword, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 5:
                        error_6 = _a.sent();
                        throw new Error("Unable to authenticate user ".concat(error_6));
